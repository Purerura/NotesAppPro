...
class NotesApp:
    ...
    def load_notes(self):
        ...
        #файл не найден при первом запуске или повреждён - начинает с пустым списком
...
#запускаем программу только при прямом запуске файла, не при подключении к другому коду
